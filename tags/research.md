...
{% assign research-tag-count = 0 %}
{% assign sorted = site.tags.research | sort: 'date' | reverse  %}
{% for post in sorted %}

<div style="animation-delay:calc({% increment research-tag-count %} * 0.2s);" class="gallery">
