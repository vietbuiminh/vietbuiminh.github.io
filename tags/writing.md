...
{% assign writing-tag-count = 0 %}
{% assign sorted = site.tags.writing | sort: 'date' | reverse  %}
{% for post in sorted %}

<div style="animation-delay:calc({% increment writing-tag-count %} * 0.2s);" class="gallery">
